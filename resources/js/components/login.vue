...
<script>
    export default{
        props: ['token_csrf'], //analoga ao atributo data
        data(){
            return{
                email: '',
                password: ''
        ...
        methods: {
            // aula 346
            //  Essa funcao é executada no envio do form
            //  Permite o login na API
            login(e){
                ...
                fetch(url,configuracao)
                    ...
                    .then(data => {
                        ...
                        //Continua o envio do formulario para o laravel autenticar no front
                        e.target.submit()
                    })
